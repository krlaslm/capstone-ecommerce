...
import { BiMenuAltLeft, BiRun } from "react-icons/bi";
          ...
          <div>
            <Link to="/">
              <div className="flex items-center mt-3 cursor-pointer">
                <span className="font-bold text-teal-400 text-[30px]">
                  RunnersRealm
                </span>
                <BiRun size={24} className="ml-1 text-teal-600" />
              </div>
                ...
                <div>
                  <Link to="/profile">
                    <img
                      src={`${backend_url}${user.avatar}`}
                      alt=""
                      className="w-[60px] h-[60px] rounded-full object-cover border-[3px] border-[#3ad132]"
                    />
                  </Link>
                </div>
              ) : (
