      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at runnersrealmsupp01@gmail.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                runnersrealmsupp01@gmail.com, or by calling us at (+65) 12345678
                between the hours of 9am and 5pm GMT+8, Monday to Friday.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within Singapore.
              </p>
            </div>
          )}
        </div>
